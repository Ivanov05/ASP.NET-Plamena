...
namespace ASP.NET_Plamena.Controllers
{
    public class ArtistsController : Controller
    {
        private readonly ASPNET_PlamenaContext _context;

        public ArtistsController(ASPNET_PlamenaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artist != null ? 
                          ...
                          Problem("Entity set 'ASPNET_PlamenaContext.Artist'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ASPNET_PlamenaContext.Artist'  is null.");
            }
            var artist = await _context.Artist.FindAsync(id);
            if (artist != null)
            {
